...
def get_json_from_file(filename: str, path: str = './src/data/'):
    with open(f"{path}{filename}", "r") as file:
        return json.load(file)


def save_to_json_file(json_data, filename: str, path: str ="./src/data/"):
    """
        Desc:
        ...
        Params:
            ...
            :param path: the save folder path - './src/data/' by default
    """
